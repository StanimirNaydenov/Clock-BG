...
define('LUXURY_WATCHES_NOTICE_BUY_NOW',__('https://www.wpradiant.net/products/watch-store-wordpress-theme','luxury-watches'));

define('LUXURY_WATCHES_BUY_BUNDLE',__('https://www.wpradiant.net/products/wordpress-theme-bundle','luxury-watches'));
...
function luxury_watches_admin_notice_style() {
	wp_enqueue_style('luxury-watches-custom-admin-notice-style', esc_url(get_template_directory_uri()) . '/get-started/getstart.css');
}
add_action('admin_enqueue_scripts', 'luxury_watches_admin_notice_style');
        ...
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get-start" style="display: flex;padding: 10px;">
        		<div class="notice-content">
	        		<div class="notice-holder">
	                        <h5><span class="theme-name"><span><?php echo __('Welcome to Luxury Watches', 'luxury-watches'); ?></span></h5>
	                        <h1><?php echo __('Enhance Your Website Development with Radiant Blocks!!', 'luxury-watches'); ?></h1>
	                        </h3>
	                        <div class="notice-text">
	                            <p class="blocks-text"><?php echo __('Effortlessly craft websites for any niche with Radiant Blocks! Experience seamless functionality and stunning responsiveness as you enhance your digital presence with Block WordPress Themes. Start building your ideal website today!', 'luxury-watches') ?></p>
	                        </div>
	                        <a href="<?php echo esc_url(admin_url('themes.php?page=luxury-watches')); ?>" id="install-activate-button" class="button admin-button info-button"><?php echo __('Getting started', 'luxury-watches'); ?></a>

	                        <a href="<?php echo esc_url( LUXURY_WATCHES_NOTICE_BUY_NOW ); ?>" target="_blank" id="go-pro-button" class="button admin-button buy-now-button"><?php echo __('Buy Now ', 'luxury-watches'); ?></a>

	                        <a href="<?php echo esc_url( LUXURY_WATCHES_BUY_BUNDLE ); ?>" target="_blank" id="bundle-button" class="button admin-button bundle-button"><?php echo __('Get Bundle', 'luxury-watches'); ?></a>
	            	</div>
	            </div>
