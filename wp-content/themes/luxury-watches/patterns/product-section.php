 ...
 * Product Section
 * 
 * slug: luxury-watches/product-section
...
<h2 class="wp-block-heading has-text-align-left has-primary-color has-text-color has-barlowcondensed-font-family has-large-font-size" style="font-style:normal;font-weight:600;letter-spacing:1px">'. esc_html__('SOME OF OUR FAVORITES.','luxury-watches') .'</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<div class="wp-block-button has-custom-font-size has-barlowcondensed-font-family has-medium-font-size" style="letter-spacing:1.5px"><a class="wp-block-button__link has-primary-color has-background-background-color has-text-color has-background wp-element-button" style="border-radius:30px"><strong>'. esc_html__('VIEW ALL','luxury-watches') .'</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h3 class="wp-block-heading has-text-align-left has-robotoflex-font-family has-upper-heading-font-size" style="margin-top:var(--wp--preset--spacing--20);margin-right:0;margin-bottom:var(--wp--preset--spacing--20);margin-left:0;font-style:normal;font-weight:500;letter-spacing:1px">'. esc_html__('Olevs Luxury Quartz Sports Chronograph','luxury-watches') .'<br>'. esc_html__('Waterproof Analog Watch','luxury-watches') .'</h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-left has-robotoflex-font-family has-upper-heading-font-size" style="margin-top:var(--wp--preset--spacing--20);margin-right:0;margin-bottom:var(--wp--preset--spacing--20);margin-left:0;font-style:normal;font-weight:400;letter-spacing:1px">'. esc_html__('Olevs Luxury Quartz Sports Chronograph','luxury-watches') .'<br>'. esc_html__('Waterproof Analog Watch','luxury-watches') .'</h3>
<!-- /wp:heading -->
